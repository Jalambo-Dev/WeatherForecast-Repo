...
class CityInfoListWidget extends StatelessWidget {
  const CityInfoListWidget({
    super.key,
        ...
        children: [
          ...
          ListView.separated(
            ...
            itemBuilder: (context, index) {
              return ListTile(
                leading: Lottie.asset(WeatherService()
                    .getWeatherAnimation(weatherModel!.hourlyConditons[index])),
                title: Text(
                ...
                subtitle: Text(
                  "${weatherModel?.hourlyTemperatures[index]}°",
                  textAlign: TextAlign.center,
                ),
